...
- `llvm-ir`: Written in LLVM IR, generated by APIs in `std.zig.llvm.Builder`.
  ...
  - Does not work with Zig's self-hosted x86 backend due to a miscompilation on the Zig side.
